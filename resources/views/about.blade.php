...
<main>
    ...
    <div class="page-banner-area page-banner-height" data-background="public/assets/img/banner/page-banner-1.jpg">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
    ...
    <!-- about-area-start -->
    <div class="about-area pt-80 pb-80" data-background="public/assets/img/bg/about-bg.png">
        <div class="container">
            <div class="row align-items-center">
               ...
               <div class="col-xl-6 col-lg-6">
                    <div class="about-image w-img">
                        <img src="public/assets/img/about/about-b.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="main-abs mb-30">
                        <div class="ab-counter-image w-img mb-40">
                            <img src="public/assets/img/about/ab-01.jpg" alt="">
                        </div>
                        <div class="row">
                                ...
                                <div class="ab-counter-item mb-30">
                                    <div class="ab-counter mb-20">
                                        <div class="counter-icon mr-10">
                                            <img src="public/assets/img/about/c-icon-01.png" alt="">
                                        </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="main-abs mb-30">
                        <div class="ab-counter-image w-img mb-40">
                            <img src="public/assets/img/about/ab-02.jpg" alt="">
                        </div>
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="ab-counter-item mb-30">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="location-item mb-30">
                        <div class="location-image w-img mb-20">
                            <img src="public/assets/img/location/location-1.jpg" alt="">
                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="location-item mb-30">
                        <div class="location-image w-img mb-20">
                            <img src="public/assets/img/location/location-2.jpg" alt="">
                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="location-item mb-30">
                        <div class="location-image w-img mb-20">
                            <img src="public/assets/img/location/location-3.jpg" alt="">
                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="location-item mb-30">
                        <div class="location-image w-img mb-20">
                            <img src="public/assets/img/location/location-4.jpg" alt="">
                        </div>
                    ...
                    <div class="cta-item mb-30">
                        ...
                        <div class="cta-apps">
                            <div class="apps-store">
                                <a href="#"><img src="public/assets/img/brand/app_ios.png" alt=""></a>
                                <a href="#"><img src="public/assets/img/brand/app_android.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
