...
<head>
    ...
    <link rel="stylesheet" href="public/assets/flaticon/flaticon.css">
...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                            <div class="header__info">
                                <div class="logo">
                                    <a href="{{url('/')}}" class="logo-image"><img
                                            src="public/assets/img/logo/logo1.svg" alt="logo"></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="cat-toggle">
                                ...
                                <div class="cat__menu-2 cat__menu">
                                    <nav id="mobile-menu" style="display: block;">
                                        <ul>
                                            <li>
                                                <a href="{{url('shop')}}">All Categories <i
                                            ...
                                            <li>
                                                <a href="{{url('shop')}}">Phone and Electronics <i
                                                        class="far fa-angle-down"></i></a>
                                            ...
                                            <li>
                                                <a href="{{url('shop')}}">Best Seller Products
                                            ...
                                            <li>
                                                <a href="{{url('shop')}}">Top 10 Offers
                                                    <span class="cat-label green">new!</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{url('shop')}}">New Arrivals <i
                                                        class="far fa-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="{{url('shop')}}">Home Appliances</a></li>
                                                    <li><a href="{{url('shop')}}">Technology</a>
                                                        <ul class="submenu">
                                                            <li><a href="{{url('shop')}}">Storage Devices</a></li>
                                                            <li><a href="{{url('shop')}}">Monitors</a></li>
                                                            <li><a href="{{url('shop')}}">Laptops</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="{{url('shop')}}">Office Equipments</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="{{url('shop')}}">TV &amp; Audio</a></li>
                                            <li><a href="{{url('shop')}}">Electronics &amp; Digital</a></li>
                                            <li class="d-laptop-none"><a href="{{url('shop')}}">Fashion &amp;
                                                    Clothings</a></li>
                                            <li class="d-laptop-none"><a href="{{url('shop')}}">Jewelry &amp; Watches</a>
                                            </li>
                                            <li><a href="{{url('shop')}}">Health &amp; Beauty</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-xl-4 col-lg-5 col-md-8">
                            <div class="footer__widget">
                                ...
                                <div class="footer__widget-content">
                                    <p class="footer-text mb-25">DukaMarket App is now available on App Store & Google
                                        Play. Get it now.</p>
                                    <div class="apps-store mb-20">
                                        <a href="#"><img src="public/assets/img/brand/app_ios.png"
                                                alt=""></a>
                                        <a href="#"><img src="public/assets/img/brand/app_android.png"
                                                alt=""></a>
                                    </div>
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-5 col-md-6">
                            <div class="footer__widget">
                                ...
                                <div class="footer__widget-content">
                                    <p class="footer-text mb-25">Join 60.000+ subscribers and get a new discount coupon
                                        on every Saturday.</p>
                                    <div class="footer__newsletter-form">
                                        <form action="#">
                                            <input class="ft-newsl b-radius" type="email"
                                                placeholder="Enter your email ...">
                                            <button class="ft-newsl-btn" type="submit">subscribe</button>
                                        </form>
                                    </div>
                                    <p class="provide-text mt-20">By providing your email address, you agree to our
                                        <br> <a href="#">Privacy Policy</a> and <a href="#">Terms of
                                            Service</a> .
                                    </p>
                                </div>
                            </div>
    ...
    <script src="public/assets/js/tweenmax.js"></script>
